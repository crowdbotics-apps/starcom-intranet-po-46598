"""
Django settings for starcom_intranet_po_46598 project.
...
ROOT_URLCONF = 'starcom_intranet_po_46598.urls'
...
WSGI_APPLICATION = 'starcom_intranet_po_46598.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "starcom_intranet_po_46598 API",
    "DESCRIPTION": "API documentation for starcom_intranet_po_46598 App",
    "VERSION": "v1",
}
